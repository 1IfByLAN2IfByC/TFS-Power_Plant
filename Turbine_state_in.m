...
function eff = Turbine(state_in, T_out, P_out, Y)
	...
	state_out_s(1,1) = Bisect_entropy(state_in,...
        state_out(1,2), 2*T_out, .5*T_out, Y, .0000001 );
	...
	%CALCULATE EFF.
	eff = ( state_in(1,3) - state_out(1,3) ) / ...
        ( state_in(1,3) - state_out_s(1,3)); 

...
=======
function P_out = Bisect_entropy_pressure(state_in, T_s, high, low, Y, tolerance) 
>>>>>>> DELETE
    it = 0;
    % arg = X(1);
    % co2 = X(2);
...
=======
    f_high = propertycalc(T_s, high, Y) - IN(4);
    f_low = propertycalc(T_s, low, Y) - IN(4);
>>>>>>> DELETE
...
=======
        f_mid = propertycalc(T_s, mid, Y) - IN(4);
>>>>>>> DELETE
